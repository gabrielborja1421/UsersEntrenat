...
var SetAsInactiveController = /** @class */ (function () {
    function SetAsInactiveController(setAsInactiveUseCase) {
        this.setAsInactiveUseCase = setAsInactiveUseCase;
    }
    SetAsInactiveController.prototype.run = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, InactivatedUser, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.body.id;
                        return [4 /*yield*/, this.setAsInactiveUseCase.run(id)];
                    case 1:
    ...
    return SetAsInactiveController;
}());
