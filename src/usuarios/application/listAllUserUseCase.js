...
var ListAllUserUseCase = /** @class */ (function () {
    function ListAllUserUseCase(usuarioRepository) {
     ...
     */
    ListAllUserUseCase.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var listAllActiveUser, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.usuarioRepository.listAllUsers()];
                    case 1:
                        listAllActiveUser = _a.sent();
                        if (listAllActiveUser) {
                            return [2 /*return*/, listAllActiveUser];
                        }
                        else {
                    ...
                    case 2:
                        ...
                        throw new Error("Error al obtener la lista de usuarios: " + err_1.message);
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    return ListAllUserUseCase;
}());
