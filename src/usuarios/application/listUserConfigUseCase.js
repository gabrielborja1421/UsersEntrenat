...
var GetUserConfigByIdUseCase = /** @class */ (function () {
    function GetUserConfigByIdUseCase(userRepository) {
        this.userRepository = userRepository;
    }
    GetUserConfigByIdUseCase.prototype.run = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var getUserById, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.userRepository.getUserConfigById(id)];
                    case 1:
                        getUserById = _a.sent();
                        if (getUserById === null) {
                        ...
                        return [2 /*return*/, getUserById];
                    case 2:
                        error_1 = _a.sent();
                        // Captura y registra el error
                        console.error("Error en GetUserByIdUseCase:", error_1);
    ...
    return GetUserConfigByIdUseCase;
}());
