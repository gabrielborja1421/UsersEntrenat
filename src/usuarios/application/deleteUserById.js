...
var DeleteUserUseCase = /** @class */ (function () {
    function DeleteUserUseCase(userRepository) {
     ...
     */
    DeleteUserUseCase.prototype.run = function (id) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.userRepository.deleteUserById(id)];
                    case 1:
                        // Llama al método de repositorio para eliminar el usuario por su UUID.
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        ...
                        console.error("Error al eliminar el usuario:", error_1);
                        // Devuelve null para indicar un error.
                        throw ({
                            error: error_1,
                            exception: error_1.message
                        });
